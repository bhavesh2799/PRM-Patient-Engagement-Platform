...
export async function runSeed(force = false): Promise<void> {
  ...
  // Templates - SMS
  const [t1, t2, t3, t4, t5, t6, t7, t8, t9] = await db.insert(templatesTable).values([
    {
      name: "Appointment Reminder (SMS)",
      channel: "sms",
      goal: "Appointment Reminder",
      language: "English",
      body: "Dear {first_name}, your appointment with {doctor_name} is scheduled on {appointment_date} at Sunrise Hospital. Please arrive 15 min early. Helpline: 080-4567-8901. To cancel reply STOP.",
      dltRegisteredBody: "Dear {first_name}, your appointment with {doctor_name} is scheduled on {appointment_date} at Sunrise Hospital. Please arrive 15 min early. Helpline: 080-4567-8901. To cancel reply STOP.",
      status: "approved",
      scope: "global",
      senderId: "SUNRSE",
      perMessageCost: "0.08",
    ...
    {
      name: "Win-back – Lapsed Patients (SMS)",
      channel: "sms",
      goal: "Win-back",
      language: "English",
      body: "Hi {first_name}, we miss you! It's been a while since your last visit to Sunrise Hospital. Book your follow-up today – call 080-4567-8901 or visit sunrisehospital.in. Reply STOP to opt-out.",
      dltRegisteredBody: "Hi {first_name}, we miss you! It's been a while since your last visit to Sunrise Hospital. Book your follow-up today – call 080-4567-8901 or visit sunrisehospital.in. Reply STOP to opt-out.",
      status: "approved",
      scope: "global",
      senderId: "SUNRSE",
      perMessageCost: "0.08",
    },
    {
      ...
      goal: "Promotional",
      language: "English",
      body: "FREE Cardiac Screening Camp at Sunrise Hospital on 20 Jun. ECG + Echo at no cost. Limited slots – register at 080-4567-8901. Reply STOP to opt-out.",
      dltRegisteredBody: "FREE Cardiac Screening Camp at Sunrise Hospital on 20 Jun. ECG + Echo at no cost. Limited slots – register at 080-4567-8901. Reply STOP to opt-out.",
      status: "approved",
      scope: "global",
      senderId: "SUNRSE",
      perMessageCost: "0.08",
    ...
    {
      name: "Chronic Care – Diabetes Follow-up (SMS)",
      channel: "sms",
      goal: "Chronic Care",
      language: "English",
      body: "Dear {first_name}, your HbA1c test is due. Early monitoring prevents complications. Book today at Sunrise Hospital – 080-4567-8901. Reply STOP to unsubscribe.",
      dltRegisteredBody: "MISMATCH - this will trigger DLT check failure",
      status: "approved",
      scope: "global",
      senderId: "SUNRSE",
      perMessageCost: "0.08",
    ...
    {
      name: "New Ortho Services (WhatsApp)",
      channel: "whatsapp",
      goal: "Promotional",
      language: "English",
      body: "Dear {first_name},\n\nSunrise Hospital is proud to announce our new *Robotic-Assisted Orthopedic Surgery* program.\n\n✅ Faster recovery\n✅ Minimally invasive\n✅ Expert team led by Dr. Ramesh Nair\n\nBook a free consultation: 080-4567-8901",
      status: "approved",
      scope: "global",
      metaStatus: "PENDING",
    ...
    // Push
    {
      name: "Health Tip – Push Notification",
      channel: "push",
      goal: "Chronic Care",
      language: "English",
      body: "Your weekly health tip from Sunrise Hospital: Stay hydrated! Drink at least 8 glasses of water daily to support your recovery and overall wellbeing.",
      status: "approved",
      scope: "global",
      perMessageCost: "0.03",
    },
  ...
  await db.insert(templateRequestsTable).values([
    {
      name: "Monsoon Health Camp – Hindi",
      channel: "sms",
      message: "Monsoon Swasthya Camp – Sunrise Hospital mein FREE OPD, 15 Jul se 20 Jul. Aaj hi register karein: 080-4567-8901",
      goal: "Promotional",
      variables: "none",
    ...
    },
    {
      ...
      channel: "whatsapp",
      message: "Dear {first_name}, your child's {vaccination_name} vaccination is due on {due_date}. Please visit Sunrise Hospital Paediatrics Dept. Questions? Reply here.",
      goal: "Chronic Care",
    ...
    {
      name: "Oncology Support Group Invite (WhatsApp)",
      channel: "whatsapp",
      message: "Dear {first_name}, join our monthly Cancer Support Group session on {session_date}. Connect with fellow patients and our counsellors. Register: 080-4567-8901",
      goal: "Chronic Care",
      variables: "session_date",
      approvalStage: "ap_marketing",
      createdBy: String(u1.id),
      rejectionReason: null,
    },
